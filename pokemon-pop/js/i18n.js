...
(function (PT) {
  ...
  const STR = {
    ko: {
      ...
      credit:
        "Holo effect adapted from simeydotme/pokemon-cards-css & pokemon-cards-151 (GPL-3.0). 151 ball foils: https://poke-151.simey.me/. Card images via Pokémon card sources. BRG POP는 매시간 자동 갱신. eBay 시세는 GitHub Secrets(EBAY_CLIENT_ID/SECRET) 등록 후 수집됩니다.",
      setFallback: "세트",
      editionJp: "일판",
      editionKr: "한글판",
      editionEn: "영판",
      ...
      packNoCardsYet: "카드 목록 준비 중",
      ebayPriceLink: "eBay에서 검색 →",
      emptyPackCards: "카드 목록 준비 중",
      tabBoosters: "확장팩",
      tabPromos: "프로모",
    ...
    en: {
      ...
      packOpenPokekyun: "PokéKyun Collection",
      backPacks: "← Packs",
      ...
      credit:
        "Holo effect adapted from simeydotme/pokemon-cards-css & pokemon-cards-151 (GPL-3.0). 151 ball foils: https://poke-151.simey.me/. Card images via Pokémon card sources. BRG POP refreshes hourly. eBay prices require GitHub Secrets EBAY_CLIENT_ID / EBAY_CLIENT_SECRET.",
      setFallback: "Set",
      editionJp: "Japanese",
      editionKr: "Korean",
      editionEn: "English",
      ...
      packNoCardsYet: "Card list coming soon",
      ebayPriceLink: "Search on eBay →",
      emptyPackCards: "Card list coming soon",
    ...
    ja: {
      ...
      credit:
        "Holo effect adapted from simeydotme/pokemon-cards-css & pokemon-cards-151 (GPL-3.0). 151 ball foils: https://poke-151.simey.me/. Card images via Pokémon card sources. BRG POPは毎時自動更新。eBay相場はGitHub Secrets（EBAY_CLIENT_ID/SECRET）登録後に収集されます。",
      setFallback: "セット",
      editionJp: "日本版",
      editionKr: "韓国版",
      editionEn: "英語版",
      ...
      packNoCardsYet: "カード一覧準備中",
      ebayPriceLink: "eBayで検索 →",
      emptyPackCards: "カード一覧準備中",
      tabBoosters: "拡張パック",
      tabPromos: "プロモ",
      ...
      <div class="nav-drawer__body">
        ...
        <section class="nav-drawer__section">
          ...
          <div class="nav-drawer__links">
            ...
            <a class="nav-drawer__link" href="./open-pokekyun.html">${PT.t("packOpenPokekyun")}</a>
          </div>
        </section>
